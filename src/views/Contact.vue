    ...
    <div class="row">
      ...
      <div class="col-full s-content__main">
        <p class="lead">
          ...
          occaecat Excepteur nisi esse veniam dolor consectetur minim qui nisi
          esse deserunt commodo ea enim ullamco non voluptate consectetur minim
        ...
        <form name="cForm" id="cForm" method="post" action="">
          <fieldset>
            ...
            <button type="submit" class="submit btn btn--primary full-width">
              Submit
            </button>
          </fieldset>
        </form>
