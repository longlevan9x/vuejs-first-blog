  ...
  <section class="s-content s-content--narrow s-content--no-padding-bottom">
    <article class="row format-gallery">
        ...
        <div class="s-content__slider slider">
          <div class="slider__slides">
            <div class="slider__slide">
              <img
                src="/assets/images/thumbs/single/gallery/single-gallery-01-1000.jpg"
                srcset="
                  /assets/images/thumbs/single/gallery/single-gallery-01-2000.jpg 2000w,
                  /assets/images/thumbs/single/gallery/single-gallery-01-1000.jpg 1000w,
                  /assets/images/thumbs/single/gallery/single-gallery-01-500.jpg   500w
                "
            ...
            <div class="slider__slide">
              <img
                src="/assets/images/thumbs/single/gallery/single-gallery-02-1000.jpg"
                srcset="
                  /assets/images/thumbs/single/gallery/single-gallery-02-2000.jpg 2000w,
                  /assets/images/thumbs/single/gallery/single-gallery-02-1000.jpg 1000w,
                  /assets/images/thumbs/single/gallery/single-gallery-02-500.jpg   500w
                "
                sizes="(max-width: 2000px) 100vw, 2000px"
                alt=""
              />
            ...
            <div class="slider__slide">
              <img
                src="/assets/images/thumbs/single/gallery/single-gallery-03-1000.jpg"
                srcset="
                  /assets/images/thumbs/single/gallery/single-gallery-03-2000.jpg 2000w,
                  /assets/images/thumbs/single/gallery/single-gallery-03-1000.jpg 1000w,
                  /assets/images/thumbs/single/gallery/single-gallery-03-500.jpg   500w
                "
                sizes="(max-width: 2000px) 100vw, 2000px"
                alt=""
              />
      ...
      <div class="col-full s-content__main">
        ...
        <p>
          <img
            src="/assets/images/wheel-1000.jpg"
            srcset="
              /assets/images/wheel-2000.jpg 2000w,
        ...
        <p>
          ...
          minus <a href="http://#">omnis voluptas assumenda est</a> id quod
          maxime placeat facere possimus, omnis dolor repellendus. Temporibus
        ...
        <p>
          ...
          occaecati cupiditate non provident, similique sunt in culpa. Aenean eu
          leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum.
          Nulla vitae elit libero, a pharetra augue laboris in sit minim
          cupidatat ut dolor voluptate enim veniam consequat occaecat fugiat in
          adipisicing in amet Ut nulla nisi non ut enim aliqua laborum mollit
        ...
        <p>
          ...
          ornare sem lacinia quam venenatis vestibulum. Nulla vitae elit libero,
          a pharetra augue laboris in sit minim cupidatat ut dolor voluptate
          enim veniam consequat occaecat fugiat in adipisicing in amet Ut nulla
          nisi non ut enim aliqua laborum mollit quis nostrud sed sed.
        </p>
            ...
            <li class="thread-alt depth-1 comment">
              <div class="comment__avatar">
                <img
                  ...
                  height="50"
                  class="avatar"
                  src="/assets/images/avatars/user-04.jpg"
                  alt=""
                />
              </div>
