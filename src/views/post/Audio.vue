    ...
    <article class="row format-audio">
      ...
      <div class="s-content__media col-full">
        <div class="s-content__post-thumb">
          <img
            src="/assets/images/thumbs/single/audio/audio-1000.jpg"
            srcset="
              /assets/images/thumbs/single/audio/audio-2000.jpg 2000w,
              /assets/images/thumbs/single/audio/audio-1000.jpg 1000w,
              /assets/images/thumbs/single/audio/audio-500.jpg   500w
            "
          ...
          <div class="audio-wrap">
            <audio
              id="player2"
              src="/assets/media/AirReview-Landmarks-02-ChasingCorporate.mp3"
              width="100%"
              height="42"
              controls="controls"
            ></audio>
